...
public class RequisitoController {
    ...
    public RequisitoController(String funcionalidade, String modulo, String nomeRequisito, String textDescrucai, String fase, int prioridade, String estado, int complexidade, int IDProjeto, int IDUsuario) {
