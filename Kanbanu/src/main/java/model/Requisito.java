...
public class Requisito {
    ...
    public void salvarRequisito(String funcionalidade, String modulo, String nomeRequisito, String textDescricao, String fase, String estado, int prioridade, int complexidade, int IDProjeto, int IDUsuario) throws SQLException {
        String sqlInsert = "insert into Kanbanu.Requisito(fk_id_Projeto,fk_id_usuario,dataCriacao,nomeRequisito,moduloRequisito,funcionalidadeRequisito,faseRequisito,prioridadeRequisito,complexidadeRequisito,estadoRequisito,descricaoRequisito) values ((select id from Kanbanu.Projeto where id = ?),?, now(),?,?,?,?,?,?,?,?)";
        ...
        stm.setString(10, textDescricao);
        stm.execute();
    }
    ...
    public ArrayList<String> buscarRequisito(int iDUsuario, int iDProjeto) throws SQLException {
        ...
        String sql = "select * from Kanbanu.Requisito where fk_id_Projeto = ? and fk_id_usuario = ? ";
